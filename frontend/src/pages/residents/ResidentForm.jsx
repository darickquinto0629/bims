    ...
    <div>
      ...
      <form className="space-y-6 max-w-2xl bg-white p-8 rounded-lg shadow-md" onSubmit={submit}>
        ...
        <div className="flex gap-3 pt-4">
          <button className="px-6 py-3 bg-gradient-to-r from-green-500 to-green-600 text-white font-semibold rounded-lg hover:shadow-lg transition-shadow duration-200">Save Changes</button>
